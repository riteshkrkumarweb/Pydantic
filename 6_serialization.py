...
exports_particular = patient1.model_dump(include=['name','gender']) #only include the name and gender and export it  
print(exports_particular)
print(type(exports_particular))

exports_particular_ex = patient1.model_dump(exclude=['name','gender']) #only exclude the name and gender and export all things except name and gender 
print(exports_particular_ex)
print(type(exports_particular_ex))

exports_particular_s = patient1.model_dump(exclude={'address':['state']})  #only exclude the state from the address 
